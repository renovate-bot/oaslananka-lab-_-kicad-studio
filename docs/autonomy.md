...
- **GitHub-secrets minimum:** Release, mirror, Codecov, and Jules secrets live in GitHub Actions secrets only when required by their workflows. Tokens are never stored in the repository.
...
2. CI, security scans, CodeQL, Scorecard, package checks, and Jules automation run in the organization repository.
...
5. The personal showcase mirror does not run CI/CD, publishing, Jules, or release automation.
